...
public class OnlineMarketMapFunctionV2 extends RichMapFunction<String, String> {

    private static final Logger LOG = LoggerFactory.getLogger(OnlineMarketMapFunctionV2.class);
    ...
    public OnlineMarketMapFunctionV2() {
    }
