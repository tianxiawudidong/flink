...
public class GetTuple5ByFWCMFunction implements MapFunction<String, Tuple5<String, Integer, Double, Integer, Integer>> {

    private static final Logger LOG = LoggerFactory.getLogger(GetTuple5ByFWCMFunction.class);
